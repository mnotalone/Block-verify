          ...
          >
            <div className="relative w-full h-[500px]">
              ...
              <motion.div
                ...
                className="absolute inset-0"
              >
                <div className="absolute top-0 right-1/2 -translate-y-1/2 w-16 h-16 bg-card/80 backdrop-blur-md border border-primary/30 rounded-xl flex items-center justify-center">
