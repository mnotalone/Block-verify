...
const steps = [
  ...
  },
  {
    icon: Hash,
    title: "Generate Hash",
    description: "SHA-256 algorithm creates a unique, tamper-proof digital fingerprint called Hash",
    color: "secondary",
  },
  {
    icon: Database,
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A simple four-step process to ensure your credentials are <b>verified and secure</b>
          </p>
        </motion.div>
