...
const LoginPage = () => {
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* Main Content */}
      <section className="flex-1 relative flex items-center justify-center overflow-hidden pt-20 pb-20">
        {/* Animated Background */}
        <div className="absolute inset-0 bg-gradient-dark overflow-hidden">
          ...
          />
          <motion.div
            className="absolute top-1/2 left-1/2 w-[400px] h-[400px] bg-accent/10 rounded-full blur-[100px]"
            animate={{
              x: [-200, -100, -200],
              y: [-200, -100, -200],
              scale: [1, 1.3, 1],
        ...
        <div className="relative z-10 w-full max-w-md mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="bg-card/50 backdrop-blur-md border border-border rounded-2xl p-8 md:p-10 shadow-2xl"
          >
            {/* Header */}
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">Sign in to your BLOCK VERIFY account</p>
            </div>
            ...
            <form className="space-y-6">
              ...
              <Button
                type="submit"
                size="lg"
                className="w-full bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg hover:shadow-primary/50 transition-all group relative overflow-hidden"
              >
                <motion.div
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button
                variant="outline"
                className="border-border hover:bg-accent/10 hover:border-accent/50"
              >
